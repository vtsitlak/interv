...
MAX_LINK_URL_CHARS = int(os.getenv('INGEST_MAX_LINK_URL_CHARS', '2048'))
MAX_LINK_DESC_CHARS = int(os.getenv('INGEST_MAX_LINK_DESC_CHARS', '200'))
MAX_TITLE_QUERY_CHARS = int(os.getenv('PROFILE_MAX_TITLE_CHARS', '200'))
MAX_SUMMARY_QUERY_CHARS = int(os.getenv('PROFILE_MAX_SUMMARY_CHARS', '2000'))
...
FEEDBACK_MAX_PER_HOUR = int(os.getenv('FEEDBACK_MAX_PER_HOUR', '60'))
MAX_FEEDBACK_TEXT_CHARS = int(os.getenv('MAX_FEEDBACK_TEXT_CHARS', '4000'))
